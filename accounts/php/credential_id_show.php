<?php
	...
	//echo json_encode($credentialID .' '. $frontback);
    ...
    foreach($result as $row){
    	...
    	if($frontback == "front") {
    		echo '<img src="../assets/credentials/'.$row["front"].'" alt="front-id" class="img-fluid">';
    	}
    	else {
    		echo '<img src="../assets/credentials/'.$row["back"].'" alt="front-id" class="img-fluid">';
    	}
    }
	/*
	$sql = "SELECT *, 
